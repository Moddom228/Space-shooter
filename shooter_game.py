...
win = font1.render('ТЫ ВЫЙГРАЛ:)', True, (25, 78, 55))
lose = font1.render('ТЫ ПРОИГРАЛ:(', True, (180, 98, 69))
...
#фоновая музыка
mixer.init()
mixer.music.load('bibizana.mp3')
mixer.music.play()
fire_sound = mixer.Sound('drott.ogg')
#нам нужны такие картинки:
img_back = "dungli.jpg" #фон игры
img_bullet = "drotik2.png" #пуля
img_hero = "muzhir.png" #герой
img_enemy = "gorila2.png" #враг
img_ast = "banan2.png" #астероид
